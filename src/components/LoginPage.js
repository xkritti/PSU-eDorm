...
const Login = (props) => {
  ...
  useEffect(() => {
    ...
    if (login.id) {
      let TestID = login.id;
      let TestName = login.username + "" + login.surname;
  ...
  return (
    <div
      style={{
        ...
        backgroundImage:
          "url(" +
          "https://images.wallpaperscraft.com/image/bulbs_chandelier_electricity_126301_3840x2400.jpg" +
          ")",
    ...
    >
      ...
      >
        <a style={{ marginTop: "20px", fontSize: "20px" }}>
          LOGIN PSU PASSPORT
        </a>
        <Form>
          <FormGroup row>
